...
cd %_full_path%
	...
	php index.php cron_job c_cron_job GetActiveItemEpid 2

REM IF ERRORLEVEL 1 GOTO :RETRY

	REM :RETRY

	REM php index.php cron_job c_cron_job GetActiveItemEpid 2
REM IF ERRORLEVEL 1 GOTO :STEP1
