...
;(function(window, undefined) {
  ...
  Display.prototype.createWindow = function(
    ...
    try {
      ...
      s += getIntAttr('x', x, 1, 20)
      s += getIntAttr('y', y, 1, 2)
      s += getIntAttr('width', width, 1, 21 - x)
      s += getIntAttr('height', hight, 1, 3 - y)
  ...
  Display.prototype.setCursorPosition = function() {
    try {
      var s = ''
      s += getIntAttr('x', arguments[0], 1, 20)
      s += getIntAttr('y', arguments[1], 1, 2)
  ...
  CookieIO.prototype = {
    ...
    getExpiredDate: function() {
      ...
      expire.setTime(nTime + 1000 * 60 * this.EXPIRE_MINUTES)
  ...
  ePOSDevice.prototype = {
      ...
      this.socket.on('disconnect', function(data) {
        try {
          if (
            ...
            if (self.cookieIo.readId() == '' && self.connectionId == null) {
              self.cleanup()
            } else {
    ...
    procConnect: function(eposmsg) {
      try {
        ...
        this.cookieIo.writeId(eposmsg.data.client_id)
  ...
  var blowfish = (function(undefined) {
    ...
    return {
      ...
      mkIV: function() {
        return i2s(Math.random() * 4294967296) + i2s(Math.random() * 4294967296)
      },
    }
  })()
