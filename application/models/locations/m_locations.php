...
///////////////////////////////////////////////
 ...
 ")->result_array();
            ...
            $images = $uri['uri'];
       return array('ebY_deta' => $ebY_deta,'eby_qyery'=>true,"images"=>$images );
      }else{     
 ...
 WHERE B.BARCODE_NO = $bar_no
   ...
   AND B.CONDITION_ID = CO.ID(+) ")->result_array();
            ...
            $images = $uri['uri'];
     return array('bar_deta' =>$bar_deta,'bar_query'=>true, "images"=>$images); // if barcode valid
  }else {
...
$uri = $this->get_pictures_by_barcode($bar_deta,$conditions);
            ...
            $images = $uri['uri'];
     return array('bar_deta' =>$bar_deta ,'det_bar'=>true, "images"=>$images); 
