...
class M_Seed extends CI_Model {
 ...
 function view($ID) {
  ...
  //select ITEM_ID,item_desc ITEM_MT_DESC,item_code laptop_item_code,item_mt_manufacture Manufacturer,item_mt_mfg_part_no mfg_part_no,item_mt_bby_sku sku_no,item_mt_upc upc from items_mt where ITEM_ID = '$item_id'

  $L_Result =$this->db->select('item_code LAPTOP_ITEM_CODE,item_desc ITEM_MT_DESC,item_mt_upc UPC,item_mt_bby_sku SKU_NO,item_mt_manufacture MANUFACTURER,item_mt_mfg_part_no MFG_PART_NO,ITEM_ID');
   $L_Result =$this->db->get_where(' items_mt', array('ITEM_ID' => $ID));
