              ...
              <div class="box"><br>    
                ...
                <div class="box-body"> 
                 <div class="col-md-12"><!-- Custom Tabs -->
                  <table id="kit-purchasing-table" class="table table-responsive table-striped table-bordered table-hover">
                    <thead>
                     <tr>
                      <th></th>
                      <th></th>
...
$(document).ready(function(){
 var data_table = $('#kit-purchasing-table').DataTable( { 
      "oLanguage": {
    ...
    ///////////////////////////////
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url().'catalogueToCash/c_purchasing/loadMpnWisePurchasing/'.$this->uri->segment(4).'/'.$this->uri->segment(5); ?>", // json datasource
    ...
    success: function (data) {
         if(data ==true){
           //window.location.href = '<?php //echo base_url(); ?>BundleKit/c_bkProfiles';
               alert("Tracking no inserted.");   
               //window.location.reload(); 
         }else if(data == false){
           alert('Error: Tracking no already exist.');
           //window.location.reload();
         }else if(data == "exist"){
            alert("Tracking no already exist.");   
               //window.location.reload();
         }
       },
