      ...
      <div class="modal-content" style="width: 100%;">
        ...
        <div class="modal-body">
          <section class="content"> 
            ...
            <textarea rows="4" cols="50" name="seller_description" class="form-control" value=""></textarea>              
          </section>                  
        </div>
...
$(document).ready(function(){
 ...
 var data_table = $('#purchasing-table').DataTable( { 
      "oLanguage": {
    ...
    ///////////////////////////////
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url().'catalogueToCash/c_purchasing/loadPurchDetail' ?>", // json datasource
...
=====================================================*/
 ...
 $(document).on('click','.seller',function(){
  ...
  track_no = $('#ct_tracking_no'+num_id+'').val();
  $('#myModal').modal('show');
