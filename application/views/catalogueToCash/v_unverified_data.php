              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-3">
                  <div class="form-group" id ="listDropDown">
                    <label for="Search Webhook">Listing Type:</label>
                      <?php $ctListingType = $this->session->unset_userdata('unverify_List_type'); ?>
                 ...
                 <div class="col-sm-3">
                  <div class="form-group" id="conditionDropdown">
                    ...
                    <?php $this->session->unset_userdata('unverify_condition');  ?>
                 ...
                 <div class="col-sm-3">
                <?php $this->session->unset_userdata('unverify_seller'); ?>  
                ...
                <div class="col-sm-3">
                    <div class="form-group" id="sortDropdown">
                        ...
                        <?php $this->session->unset_userdata('unverify_title_sort'); ?>
                        <?php
                ...
                <div class="col-sm-12">  
                  <div class="col-sm-2">
                    <div class="form-group" id="timeDropdown">
                      ...
                      <?php $this->session->unset_userdata('unverify_time_sort'); ?>
                      <?php
                  ...
                  <div class="col-sm-2">
                     <?php 
                        $this->session->unset_userdata('unverify_fed_one');
                        $this->session->unset_userdata('unverify_fed_two');
                     ?>
                    <div class="form-group">
                      <label for="Feedback Score">Feedback Score:</label>
                        <div class="input-group" >
                          ...
                          <input type="text" name ="fed_two" class="form-control clear" value="<?php echo  $this->session->userdata('unverify_fed_one');?>" />
                        </div>
                    </div>
                  </div>
                  <div class="col-sm-4 ">
                    <?php $this->session->unset_userdata('unverify_serchkeyword'); ?>  
                    <div class="form-group">
...
$("#brand").on('change',function(){
  ...
  var brand_name = $("#brand option:selected").text();
    ...
    $.ajax({
      ...
      data: { 'ct_category' : ct_category, 'brand_name':brand_name},
     success: function (data) {
        if(data){
            var mpn = [];
...
/*=====  End of Onload show mpn cateogires wise  ======*/
    ...
    // "pageLength": 5,
      ...
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url().'catalogueToCash/c_purchasing/loadData/'.$cat_id; ?>", // json datasource
