  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Lot Purchasing</li>
      </ol>
    </section>  
    <!-- Main content -->
    <section class="content"> 
       <div class="box">
            ...
            <?php } ?>    
                ...
                <form action="<?php echo base_url().'catalogueToCash/c_lot_purchasing/lot_search_Purch'; ?>" method="post" accept-charset="utf-8">
...
var data_table = $('#search-purchasing-table').DataTable( { 
    ...
    ///////////////////////////////
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url().'catalogueToCash/c_lot_purchasing/lot_loadPurch' ?>", // json datasource
        type: "post"  
