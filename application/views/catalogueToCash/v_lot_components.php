  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Lot Components</li>
      </ol>
          ...
          <?php if($this->session->flashdata('success')){ ?>
            ...
            <div class="col-sm-12" style="margin-top: 20px;">
              ...
              <div class="form-group pull-left">
                <button type="button" title="Save Components"  class="btn btn-success col-sm-offset-1 lot_save_components" id="lot_save_components">Save</button>
              </div>
            </div>
              ...
              <table  id="kit-components-table" class="table table-responsive table-striped table-bordered table-hover">
                ...
                <tbody id="reloa_id">
                  ...
                  ?>
                    <tr>
                      <td>
                        <a title="Delete Component" href="<?php echo base_url().'catalogueToCash/C_lot_purchasing/cp_delete_component/'.$cat_id.'/'.$mpn_id.'/'.$cata_id.'/'.@$result['MPN_KIT_MT_ID']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
                        </a>
                      </td>
                      <td>
                      ...
                      <td>
                      <?php $mpn_desc_check = $result['MPN_DESCRIPTION']; 
                      if(!empty($mpn_desc_check)){ ?>
                         <input type="text" name="check_mpn_desc_<?php echo $i; ?>" placeholder = "Enter Mpn Description"   class="form-control check_mpn_desc" id="check_mpn_desc_<?php echo $i; ?>" value="<?php echo @$result['MPN_DESCRIPTION']; ?>" readonly> 
                        <?php } else{ ?>
                       <input type="text" name="check_mpn_desc_<?php echo $i; ?>" placeholder = "Enter Mpn Description" required=""  class="form-control check_mpn_desc" id="check_mpn_desc_<?php echo $i; ?>" value="<?php //echo @$result['MPN_DESCRIPTION']; ?>" >
                       <?php } ?>
                      </td>
                      ...
                      <td>
                        <input type="hidden" class="part_catlg_mt_id" name="part_catlg_mt_id" id="part_catlg_mt_id" value="<?php echo @$result['PART_CATLG_MT_ID']; ?>">
                            <div class="form-group" style="width: 210px;">
                                <select class="form-control estimate_condition" name="estimate_condition" id="estimate_condition_<?php echo $i;?>" ctmt_id="<?php echo @$result['PART_CATLG_MT_ID']; ?>" rd = "<?php echo $i; ?>"  style="width: 203px;">
                                  <?php                                 
...
//                             $bar_code = $barcode_no[0]['BCD'];
            ...
            <div class="col-sm-2">
              <div class="form-group pull-right">
                <input class="form-control" type="hidden" name="kitmpnauto" id="kitmpnauto" value="<?php echo @$data['detail'][0]['MPN']; ?>">
              </div>
            </div>             
        ...
        <!-- /.box -->
         ...
         <div class="box " id="composn-toggle">
            ...
            <div class="box-body">
              <div class='col-sm-12' id="componesnt-toggle">
              <?php  //echo "<pre>";
                      //print_r ($brand);
                      //echo "</pre>";  ?>
              <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <select name="brands" id="brands" class="form-control selectpicker" data-live-search="true">
                      
                      <option value="02">Select brands</option>
                      <option value="01">...  Load All MPNs  ...</option>
                      <?php 
                      foreach($brand as $b_name): ?>
                        <option value="<?php echo $b_name['SPECIFIC_VALUE'] ?>"><?php echo $b_name['SPECIFIC_VALUE'] ?></option>
                      <?php endforeach; ?>  
                    </select>
                  </div>
                </div>
              ...
              <div class='col-sm-3'>
                <div class="form-group" id="all_MPN">   
                </div>
              </div>
              <div class='col-sm-1'>
                <div class='form-group'>
              ...
              <!-- <div class="col-sm-1">
                <div class="form-group p-t-24">
                  <input type="button" class="btn btn-success btn-sm" name="add_all_mpns" id="add_all_mpns" value="Load All MPNS">
                </div>
              </div> -->
              <!-- MPN Block end -->
            </div>
         ...
         <!-- second block  Catalogue Detail start --> 
          ...
          <div class="box" >
            ...
            <div class="box-body" id="compon-search">             
              <div class="col-sm-12">
                <div class="col-sm-3">
...
/*  $("#copy_catalogues").on('click', function(event) {
    ...
    // "pageLength": 5,
      ...
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php //echo base_url().'catalogueToCash/C_lot_purchasing/loadCatalogues/'.$cat_id.'/'.$mpn_id.'/'.$cata_id; ?>", // json datasource
...
/* $('#kit-components-table').append('<tr> <td></td> <td ></td> <td ></td><td></td><td></td><td><label>Checked: </label><p class="totalChecks"></p></td> <td> <label>Total Qty : </label> <div class="form-group"> <input type="text" name="total_component_qty" id="total_component_qty_1" class="form-control input-sm total_qty" value="0.00" style="width:80px;" readonly> </div> </td> <td><label>Total Sold Price:</label><div class="form-group"> <input type="text" name="total_sold_price" id="total_sold_price" class="form-control input-sm total_sold" value="0.00" style="width:100px;" readonly> </div></td> <td><label>Total Estimate: </label><div class="form-group"> <input type="text" name="total_estimate_price" id="total_estimate_price" class="form-control input-sm total_estimate" value="$0.00" style="width:100px;" readonly> </div></td><td><label>Total Amount: </label><div class="form-group"> <input type="text" name="total_amount" id="total_amount" class="form-control input-sm amounts" value="$0.00" style="width:100px;" readonly> </div></td><td><label>Total Ebay Fee: </label><div class="form-group"> <input type="text" name="total_ebay_fee" id="total_ebay_fee" class="form-control input-sm total_ebay" value="0.00" style="width:100px;" readonly> </div></td> <td><label>Total Paypal:</label><div class="form-group"> <input type="text" name="total_paypal_fee" id="total_paypal_fee" class="form-control input-sm total_paypal" value="0.00" style="width:100px;" readonly> </div></td> <td><label>Total Shipping:</label><div class="form-group"> <input type="text" name="total_ship_fee" id="total_ship_fee" class="form-control input-sm total_shipping" value="0.00" style="width:100px;" readonly> </div></td> <td><label>Sub Total:</label><p class="totalClass"/></p></td> </tr>');*/
  ...
  ===================================================*/
  $(document).on('click', ".lot_save_components", function(){
    $('#showAll').click();
    ...
    var fields = $("input[type='checkbox']").serializeArray(); 
      ...
      var url='<?php echo base_url() ?>catalogueToCash/C_lot_purchasing/savekitComponents';
      var mpn_desc_value = [];
      var partsCatalgid = [];
      var compName=[];
      var compQty=[];
    ...
    //category_id.push($(tdbk.rows[1].cells[2]).text());
       for (var i = 0; i < arr.length; i++)
          {
            ...
            $(tdbk.rows[arr[i]]).find(".check_mpn_desc").each(function() {
              mpn_desc_value.push($(this).val());
            });
          ...
          mpn_desc_value = mpn_desc_value.filter(v=>v!='');
          //console.log(mpn_desc_value); return false;
       ...
       if (compAmount.length < shipFee.length) {
            ...
            return false;
          }else if(mpn_desc_value.length < shipFee.length){
            alert("Warning: Please Insert  MPN Description of Selected Components");
            return false;
          }else{
              $(".loader").show();
                $.ajax({
...
/*==============================================================
  ...
  ================================================================*/
//   $('#add_all_mpns').on('click',function(){
//   var object_id = $('#bd_object').val();
//   var category_id= '<?php echo $this->uri->segment(4); ?>';
//   $(".loader").show();
  

//   $.ajax({
//     url:'<?php echo base_url(); ?>catalogueToCash/C_lot_purchasing/get_all_mpns',
//     type:'post',
//     dataType:'json',
...
//         brands.push('<option value="'+data[i].CATALOGUE_MT_ID+'">'+data[i].MPN+'</option>')
//       }
//       brands.join(" ");
//       $('#all_MPN').html("");
//       $('#all_MPN').append('<label>All MPNs:</label><select name="all_mpn" id="all_mpn" class="form-control all_mpn selectDropdown selectpicker" data-live-search="true" required>'+brands.join("")+'</select>');
//       $('.all_MPN').selectpicker();
//     },
//      complete: function(data){
//       $(".loader").hide();
//     },
...
//   $('#add_kit_component').on('click',function(){
...
//   $.ajax({
//     url:'<?php echo base_url(); ?>catalogueToCash/C_lot_purchasing/get_brands',
//     type:'post',
//     dataType:'json',
//     data:{'object_id':object_id,'category_id':category_id},
//     success:function(data){
...
//       }
//       $('#brands').html("");
//       $('#brands').append('<label>Brands:</label><select style="width:160px;" name="bd_brands" id="bd_brands" class="form-control bd_brands  " data-live-search="true" required><option value="">--- Load All MPNs ---</option>'+brands.join("")+'</select>');
//       $('.bd_brands').selectpicker();


//       // brands.join(" ");
//       // $('#all_MPN').html("");
//       // $("#all_MPN").append('<select style="width:160px;" class="form-control load_all_MPN  selectpicker " data-live-search="true"  name="all_mpn" id="load_all_MPN"><option value="">-------Select----------</option>'+brands.join(" ")+'</select>');
//       // $('#load_all_MPN').selectpicker();
...
// });
  ...
  $(".loader").show();
  $.ajax({
    url:'<?php echo base_url(); ?>catalogueToCash/C_lot_purchasing/get_mpns',
    type:'post',
    dataType:'json',
...
//       var brands = [];
//       for (var i = 0; i < data.length; i++) {
//           brands.push('<option value="'+data[i].CATALOGUE_MT_ID+'">'+data[i].MPN+'</option>'); //This adds each thing we want to append to the array in order.
//       }
//       brands.join(" ");
//       $('#all_MPN').html("");
//       $("#all_MPN").append('<label>All MPNs:</label><select style="width:160px;" class="form-control load_all_MPN  selectpicker " data-live-search="true"  name="all_mpn" id="load_all_MPN"><option value="">-------Select----------</option>'+brands.join(" ")+'</select>');
//       $('#load_all_MPN').selectpicker();
//    }
//   }); 
//  });
...
// });
  ...
  ================================================================*/
  $(document).on('click', '#save_mpn_kit', function(){
//$("#save_mpn_kit").on('click', function(){

    var url='<?php echo base_url() ?>catalogueToCash/c_lot_purchasing/addKitComponent';
    ...
    var bd_mpn                      = $("#bd_mpn").val();
    var all_MPN                     = $("#load_all_MPN").val();
    // alert(bd_mpn,all_MPN);
    // return false;
    // console.log(bd_mpn,all_MPN);
    // return false;
...
// });
  ...
  //   var url='<?php echo base_url() ?>catalogueToCash/C_lot_purchasing/createAutoKit';
  //   $(".loader").show();
  //   $.ajax({
  //   url:url,
  //   type: 'POST',
...
================================================================*/
  ...
  $(".loader").show();
  $.ajax({
    url:'<?php echo base_url(); ?>catalogueToCash/C_lot_purchasing/get_cond_base_price',
    type:'post',
    dataType:'json',
  ...
  dataTable = $('#search_component_table').DataTable({  
    ...
    // "pageLength": 5,
      ...
      "ajax":{
        ...
        url :"<?php echo base_url() ?>catalogueToCash/C_lot_purchasing/search_component", // json datasource
        type: "post"  // method  , by default get
        // data: {},
...
//$('.addtokit').on('click',function(){
  ...
  $.ajax({
        ...
        data:{'partCatalogueId':partCatalogueId,
              ...
              'inputText':inputText},
        url :"<?php echo base_url() ?>catalogueToCash/C_lot_purchasing/addtokit", // json datasource
        type: "post" ,
        dataType: 'json',
            ...
            //var row_id         = parseFloat(parseFloat(data.totals) + parseFloat(1));
                    var quantity       = data.result[0].QTY;
                     var alertMsg = "return confirm('Are you sure to delete?');";
                      var delete_comp = '<?php echo base_url(); ?>catalogueToCash/C_lot_purchasing/cp_delete_component/'+cat_id+'/'+mpn_id+'/'+cata_id+'/'+data.result[0].MPN_KIT_MT_ID;
...
$("body").on('click','.fetchobject', function(){
 ...
 $(".loader").show();
  $.ajax({
        ...
        url :"<?php echo base_url() ?>catalogueToCash/C_lot_purchasing/fetch_object", // json datasource
        type: "post" ,
        dataType: 'json',
