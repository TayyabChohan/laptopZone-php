...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'catalogueToCash/c_purchasing/searchPurchDetail'; ?>" method="post" accept-charset="utf-8">
               ...
               <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                  <div class="form-group" id="listDropDown">
                    ...
                    <?php //var_dump($this->session->userdata('Search_List_type')); ?>
                ...
                <div class="col-sm-12">
                <div class="col-sm-3">
                <?php $this->session->userdata('purch_mpn'); ?>  
                  <div class="form-group">
              ...
              <select class="form-control selectpicker" name="title_sort" id="title_sort" data-live-search="true">
           ...
           <?php //$this->session->unset_userdata('time_sort'); ?>
            ...
            <div class="col-sm-2">
              ...
              <input type="text" name ="perc_one" class="form-control input clear" VALUE="<?php echo  $this->session->userdata('perc_one');?>"  />
              <span class="input-group-addon" style="border-left: 0; border-right: 0;">To</span>
              
              <?php //$this->session->unset_userdata('perc_two'); ?>
              <input type="text" name ="perc_two" class="form-control input clear" VALUE="<?php echo  $this->session->userdata('perc_two');?>" />
              </div>
              </div>
...
<div class="col-sm-12">
                ...
                <div class="col-sm-2">
                  <div class="form-group p-t-24">
                <button type ="button" class="btn btn-sm btn-primary  float-left" id="reset">Reset Filters</button>
...
$(document).ready(function(){
 var dataTable = $('#search-purchasing-table').DataTable( {  
      "oLanguage": {
