                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      if (!empty(@$search_title)) { ?>
                        <input type="hidden" name="estimate_title" id="estimate_title" class="form-control" value="<?php echo @$search_title; ?>">
                      <?php } ?>
                    </div>                    
                    <div class="col-sm-12">
                      <div class="col-sm-2">
...
$(document).ready(function(){
  $("#market_ebay").show();
  var estimate_title = $("#estimate_title").val();
    ...
    ///////////////////////////////
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url().'itemsToEstimate/c_search_estimate/lotsData' ?>", // json datasource
        type: "post",  // method  , by default get
        data: {'estimate_title': estimate_title},
