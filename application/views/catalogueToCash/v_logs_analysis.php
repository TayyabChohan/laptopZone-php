  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Log Analysis</li>
      </ol>
    </section>  
    <!-- Main content -->
             ...
             <!--  <div class="col-sm-12">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_2" data-toggle="tab" id="secondTab">Downloaded Logs</a></li>
                  <li><a href="#tab_1" id="firstTab" data-toggle="tab">Undownloded Logs </a></li>
                </ul>
                 <div class="tab-content">
                  <div class="tab-pane <?php //if(@$activeTab == 'Not Listed'){echo 'active';}?>" id="tab_1">
                    <table id="downloded_logs" class="table table-responsive table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>FEED NAME</th>
                      <th>MIN PRICE</th>
                ...
                <div class="tab-content">
                  <div class="tab-pane <?php //if(@$activeTab == 'Not Listed'){echo 'active';}?>" id="tab_2">
                    <table id="un-downloded-logs" class="table table-responsive table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>FEED NAMEs</th>
                      <th>MIN PRICE</th>
...
function reload(){
    ...
    if(tableData != ''){
      ...
      tableData = $('#downloded_logs').DataTable({
      "oLanguage": {
      ...
      // "pageLength": 5,
        ...
        "ajax":{
          url: '<?php echo base_url();?>catalogueToCash/c_logs_analysis/loadkits', 
          type: 'post',
          dataType: 'json',
      ...
      if(dataTable != ''){
        ...
        // $('#un-downloded-logs').DataTable().fnDestroy();
        // $('#un-downloded-logs').ajax.reload();
       }

    dataTable = $('#un-downloded-logs').DataTable({
      "oLanguage": {
        "sInfo": "Total Records: _TOTAL_",
        //"sPaginationType": "full_numbers",
      ...
      // "pageLength": 5,
        ...
        "ajax":{
          url: '<?php echo base_url();?>catalogueToCash/c_logs_analysis/loadNonKits', 
          type: 'post',
          dataType: 'json',
          data:{'search_val':10}
          // success:function(data){}
...
$(document).on('click','.show_comps',function(){
  ...
  $(".loader").show();
    $.ajax({
        url: '<?php echo base_url(); ?>catalogueToCash/c_logs_analysis/show_components', 
        type: 'post',
        dataType: 'json',
