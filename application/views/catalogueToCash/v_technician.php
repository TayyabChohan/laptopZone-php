    ...
    <section class="content">
      <div class="row">
        <div class="col-sm-12">
				...
				<div class="addCompBtn">		
         		...
         		<div class="row">
					<div class="col-sm-12">
						<div class="col-sm-2">
		                	<div class="form-group p-t-24">	
		                	<input id ="update_kit_estimate" type="button" name="update_kit_estimate" class="btn btn-success btn-sm" value ="Add Compnents">
		                	</div>
		                </div>
					</div>
				</div>
		         ...
		         <div class="box">
		            ...
		            <div class="box-body">
		              ...
		              <div class='col-sm-1'>
		                <div class='form-group'>
		                  <label>Price:</label>
		                  <input class='form-control' type='text' name='kit_est_price' id='kit_est_price' value='' placeholder='Enter Price'/>
		                </div>
		              </div>     
			          <div class="col-sm-1">
			            <div class="form-group p-t-24">
		                  	<input type="button" class="btn btn-success btn-sm" name="update_mpn_kit" id="update_mpn_kit" value="Save">
			            </div>
			           </div>                                          
		            </div>
		           </div>
         ...
         <?php 
			//var_dump($data['dekits']); exit;
			if(!empty(@$data['dekits'])){
			  ?>
	        <div class="box" id = "dekit_data_section">
				
	            <div class="box-body form-scroll">	 
	        		<div class="row">
	        		<!-- <form action="<?php //echo base_url(); ?>catalogueToCash/c_technician/add_estim_data" method="post" accept-charset="utf-8"> -->
	        			<div class="col-sm-12">
							...
							<div class="col-sm-3">
								<div class="form-group">	
									<input type="hidden" name="qty2" id="qty2" class="form-control">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">	
							...
							<div class="col-sm-3">
								<div class="form-group">	
									<input type="hidden" name="received_on" id="received_on" class="form-control">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">	
									<input type="hidden" name="mpn2" id="mpn2" class="form-control">
								</div>
							</div>
							
							<div class="col-sm-12">
								<?php 
								if (!empty($data['dekits'][0]['LZ_BD_CATAG_ID'])) {
									$lz_bd_cata_id = @$data['dekits'][0]['LZ_BD_CATAG_ID'];
									?>
									<input type="hidden" name="lz_cata_id" id="lz_cata_id" value="<?php echo @$lz_bd_cata_id; ?>">
									<?php 
										}
									?>
								<table id="dekit-components-table" class="table table-responsive table-striped table-bordered table-hover">
				                <thead>
									<th>ACTION</th>
									<th>OBJECT</th>
									<th>MPN</th>
				                ...
				                <tbody id="kit_id">
								 ...
								 // print_r($data['dekits']); 
								 // exit;
								  foreach ($data['dekits'] as $value): ?>
								<tr>
									<td style="padding-top:40px;">
									<input type="hidden" name="est_det_id" id="<?php echo 'est_det_id_'.$i; ?>" value="<?php echo $value['LZ_ESTIMATE_DET_ID']; ?>" >
				                     <button type="button"  class="comp_delete btn btn-xs btn-danger " id="<?php echo @$value['LZ_ESTIMATE_DET_ID'];?>" title="Delete Component" rd="<?php echo $i; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button>
				                     <input type="checkbox" name="dekit_component" id="" value="<?php echo $value['LZ_ESTIMATE_DET_ID']; ?>" style="display: none;" checked>
				                	</td>
				                	<td style="padding-top:40px;">
				                    ...
				                    <td style="padding-top:40px;"><?php echo $value['MPN']; ?></td>
				                    <td ">
				                    	<?php

											$desc = @$value['MPN_DESCRIPTION'];
				                    	...
				                    	<input type="text" name="mpn_desc" id="mpn_desc<?php echo $i;?>" class="form-control mpn_desc" onKeyDown="textCounter(this,80);" maxlength="80" onKeyUp="textCounter(this,'titlelength<?php echo $i;?>' ,80)"  value="<?php echo htmlentities(@$item_desc); ?>" style="width: 540px;">
				                    </td>
				                    <td style="padding-top:35px;">
				                    	<?php 
			                				$ctc_kit_qty = @$this->session->userdata['ctc_kit_qty'];
				                    	?>
				                        <input type="number" name="dekit_qty" id="dekit_qty" class="form-control dekit_qty" value="<?php if(!empty($ctc_kit_qty)){ echo @$ctc_kit_qty; }?>" style="width: 60px;">
				                        <input type="hidden" name="part_mt_id" id="part_mt_id" class="form-control part_mt_id" value="<?php echo $value['PART_CATLG_MT_ID']; //if(!empty($ctc_kit_qty)){ echo $ctc_kit_qty; } ?>" >
				                    </td>
				                    <td style="padding-top:35px;">
			                    	 <div style="width: 190px;">
			                    	 	<?php $ctc_kit_cond = $this->session->userdata['ctc_kit_cond']; 
			                    	 	$tech_cond_id = @$value['TECH_COND_ID'];
			                    	 	$cond = @$value['COND'];
			                    	 	 
			                    	 	 ?>
						                      <select class="form-control dekit_condition" name="dekit_condition" data-live-search="true" style="width: 180px;">
						                      	<option value="<?php echo $tech_cond_id; ?>"><?php echo $cond; ?></option>
						                        <?php 
						                          foreach($lists['conditions'] as $type) { 
							                                        
							                              ?>
							                               <option value="<?php echo $type['ID']; ?>"><?php echo $type['COND_NAME']; ?>
							                               </option>
							                              <?php
						                              } 
						                           ?>                     
				                        ...
				                        <?php //echo $EST_SELL_PRICE = $value['EST_SELL_PRICE']; ?>
				                       <!--  <input type="hidden" name="EST_SELL_PRICE" value="<?php //echo $value['EST_SELL_PRICE']; ?>">
				                        <div class="form-group">
				                        <input type="text" name="EST_SELL_PRICE" id="QTY" class="form-control input-sm EST_SELL_PRICE" value="<?php //echo $EST_SELL_PRICE; ?>" style="width:100px;">
				                    	</div> -->
				                    </td>
				                    <td style="padding-top:35px;">
				                    	<div class="form-group">
				                    		<input type="text" name="tech_remark_<?php echo $i;?>" class="tech_remark form-control" style="width: 160px;">
				                    	</div>
				                       
				                    </td>
									<td style="padding-top:35px;">
				                      <input type="checkbox" name="specific_picture[]" id="specific_picture_<?php echo $i;?>" value="1" class="specific_picture">
				                    </td>
				                    <td style="padding-top:35px;">
				                       <input type="number" name="location_bin" class="location_bin form-control" id="" value="" style="width: 60px;">
				                    </td>
				                    <td style="padding-top:35px;">
				                       <input type="text" name="kit_brand" class="kit_brand form-control kitBrand" id="kit_brand" value="<?php echo @$data['manufacture_name']; ?>" style="width: 90px;">
				                    </td>
				                    <td style="padding-top:35px;">
				                     <input type="number" name="obj_weight<?php echo $i;?>" class="obj_weight form-control objWeight" id="obj_weight" value="" style="width: 60px;" placeholder="Oz">
				                    </td>
								</tr>
				        		<?php $i++;  endforeach;?> 
				                </tbody>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<button type="button" title="Save Estimate"  class="btn btn-primary pull-left" id="dekit_post">Save</button>        
						            </div>									
								</div>								
							</div>
							<!-- Table start -->
      ...
      <!-- ///////////////////////////////////////////////////////////////// -->
     <?php      
    if(@$data['lot_flag'] == 'lot' || @$data['lot_flag'] == 'third'){
    	if(empty(@$data['dekits'])){
     ?>
      <div id="item_components">
      ...
      <div class="col-sm-12" style="margin-left: 42%; margin-top: 20px;">
            ...
            <div class="col-sm-12">
                  ...
                  if (!empty($data['detail'])){
                  	$cond_id  = @$data['detail'][0]['CONDITION_ID'];
                  }
    ...
    $.ajax({
     ...
     if (data.res == true) {
     	...
     	$("#dekit_data_section").hide();
     		...
     		$('#errorMessage').html("");
	      	$('#errorMessage').append('<p style="color:orange;"><strong>warning: This item is de kit already!</strong></p>')
	      	// $('#errorMessage').append('<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> <strong>Warning: Please Enter Tracking # !</strong>');
	      	 $('#errorMessage').show();
	      	setTimeout(function() {
	          $('#errorMessage').fadeOut('slow');
...
$("#bd_mpn" ).change(function(){
  ...
  $.ajax({
    dataType: 'json',
    type: 'POST',
    url:'<?php echo base_url(); ?>catalogueToCash/c_technician/getMpnObjects',
    data: {'bd_mpn' : bd_mpn},
    success: function (data) {
    	$(".loader").hide();
    //console.log(data);
...
///////////////////////////////
  ...
  // alert(object_id);
  $.ajax({
    url:'<?php //echo base_url(); ?>catalogueToCash/c_technician/loadBdMpn',
    type:'post',
    dataType:'json',
  ...
  ================================================================*/
  	$("#add_component, #update_kit_estimate").click(function(){
...
$("#save_mpn_kit").on('click', function(){
    var url='<?php echo base_url() ?>catalogueToCash/c_technician/addKitComponent';
    // var bd_alt_object = $("#bd_alt_object").val();
    var ct_category_id              = $("#category_id").val();
    var catalogue_mpn_id            = $("#catalog_id").val();
    var ct_cata_id                  = $("#lz_bar_code").val();
  ...
  =               FOR SAVING KIT PARTS                           =
  ================================================================*/
$("#update_mpn_kit").on('click', function(){
    var url='<?php echo base_url() ?>catalogueToCash/c_technician/updateKitComponent';
    var ct_cata_id                  = $("#lz_bar_code").val();
    var master_mpn_id            	= $("#catalog_id").val();
    var lz_single_entry_id          = $("#lz_single_entry_id").val();
    var object_id 					= $('#bd_object').val();
    var selected_mpn 				= $('#bd_mpn').val();
    var brand_name 					= $("#bd_brands").val();
    var kit_est_price 				= $("#kit_est_price").val();
    var kit_qty                     = $("#kit_qty").val();

    //console.log(ct_cata_id, master_mpn_id, lz_single_entry_id, selected_mpn, object_id, kit_est_price, brand_name, kit_qty); return false;
    ...
    success: function (data){
      ...
      if(data == 1){
        ...
        window.location.reload();
      	...
      	alert("Warning: Component is already exist against this mpn!");
      }else if(data == 0){
  ...
  $(document).on('click', ".save_components", function(){
    ...
    //category_id.push($(tdbk.rows[1].cells[2]).text());
       for (var i = 0; i < arr.length; i++)
          ...
          partsCatalgid = partsCatalgid.filter(v=>v!='');
...
/*==============================================================
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      $('#brands').html("");
      $('#brands').append('<label>Brands:</label><select name="bd_brands" id="bd_brands" class="form-control bd_brands" data-live-search="true" required><option value="0">---select---</option>'+brands.join("")+'</select>');
      $('.brands').selectpicker();
    },
     complete: function(data){
      $(".loader").hide();
  ...
  $.ajax({
    ...
    type:'post',
    dataType:'json',
    data:{'brand_name':brand_name, 'object_id':object_id},
    success:function(data){
      var mpns = [];
       // alert(data.length);return false;
      for(var i = 0;i<data.length;i++){
      ...
      $('#bdMPN').html("");
      $('#bdMPN').append('<label>Component MPN:</label><select name="bd_mpn" id="bd_mpn" class="form-control bdMPNS" data-live-search="true" required><option value="0">---select---</option>'+mpns.join("")+'</select>');
      $('.bdMPNS').selectpicker();
    },
     complete: function(data){
      $(".loader").hide();
...
$("body").on('click','.del-components', function() {
   var lz_bd_mpn_ki_id = $(this).attr("id");
    $(".loader").show();
    $.ajax({
        url: '<?php echo base_url(); ?>catalogueToCash/c_technician/cp_del_component', //maintains the (controller/function/argument) logic in the MVC pattern
        type: 'post',
        dataType: 'json',
         data : {'lz_bd_mpn_ki_id':lz_bd_mpn_ki_id},
        success: function(data){
          $(".loader").hide();
            if(data == true){
              $(".loader").hide();
            	alert('Success: Component is deleted!');
              	window.location.reload();
            }
        },
      error: function(jqXHR, textStatus, errorThrown){
