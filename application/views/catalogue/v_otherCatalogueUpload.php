    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url();?>catalogue/c_otherCatalogueUpload/importFile" method="post" name="catalogueUpload" id="catalogueUpload" enctype="multipart/form-data">
                <div class="col-sm-12">
                    <div class="col-sm-4">
