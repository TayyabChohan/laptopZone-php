...
<section class="content">
  ...
  <div class="col-sm-12">
          ...
          <h3 class="box-title">Search Barcode</h3>
            ...
            <div class="box-body">
              <form action="<?php echo base_url(); ?>tolist/c_tolist/barcode_seed_view" method="post" accept-charset="utf-8">
                <div class="col-sm-5">
                  <div class="form-group">
                   
                      <input type="text" name="bar_search" class="form-control" placeholder="Enter Barcode" value="<?php echo htmlentities($this->session->userdata('seedbarcode')); ?>" >    
                ...
                <div class="col-sm-2">
                  <div class="form-group ">
                    <input type="submit" class="btn btn-primary btn-SM" name="barcode_submit" id="barcode_submit" value="Search">
                  </div>
                </div>
            </form>
            </div>
          ...
          ?>
            ...
            <div class="col-sm-3">        
                <div class="form-group">      
                  ...
                  <input type='text' class="form-control" id="weight" name="weight" value='<?php if(@$data_get['weight_qry'][0]['WEIGHT_KG']){echo htmlentities(@$data_get['weight_qry'][0]['WEIGHT_KG'].' Ounces');} ?>' readonly>
                </div>
            </div>            
<?php 
...
<!--            <div class="col-sm-4">   
          ...
          <div class="form-group">
              ...
              <input type="hidden" style="display:none;" name="pic_item_id" value='<?php echo @$data_get['result'][0]->ITEM_ID; ?>'/>
