  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listed Items Audit</li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', "#search_lister", function(e){
      ...
      "dom": '<"top"iflp<"clear">>rt<"bottom"iflp<"clear">>',
        ...
        "bAutoWidth": true,
        "ajax":{
        url :"<?php echo base_url().'tolist/c_tolist/loadListedItemsAudit' ?>", // json datasource
     ...
     $("#listedItems").DataTable({
      ...
      "dom":'<"top"iflp<"clear">>rt<"bottom"iflp<"clear">>',
        ...
        "bAutoWidth": true,
        "ajax":{
        url :"<?php echo base_url().'tolist/c_tolist/loadListedItemsAudit' ?>", 
        // json datasource
        type: "post" , // method by default get
        dataType: 'json',
        data: {
...
$(document).on('blur','#audit_bin_id',function(){
  ...
  $.ajax({
    dataType: 'json',
    type: 'POST',        
    url:'<?php echo base_url(); ?>tolist/c_tolist/setBinIdtoSession',
...
================================================*/
$(document).on('click','#print_bttn',function(){
...
================================================*/
$(document).on('click','#print_bttn_auto',function(){
