...
<!--             <div class="col-sm-3 pull-right p-t-24">
                  <div class="form-group">
...
<!--                                          <div class="img_overlay">
                ...
                <?php $pic_dir = $master_path.@$data_get['result'][0]->UPC.'~'.$mpn.'/'; 
  ...
  <?php if(empty(@$data_get['ship_fee_qry'][0]['SHIP_FEE'])){
    ...
    <?php } 
              ...
              <!-- <div class="col-sm-6"> 
                ...
                <span id="price_error"></span>
                  <a class="crsr-pntr" title="Click here for Price suggestion" id="seed_suggest_price">Suggest Price</a> &nbsp;&nbsp; 
              </div>
              <div class="col-sm-2"> 
...
<?php
 //if(empty(@$data_get['result'][0]->RETURN_DAYS)){$selected = 'selected'}else{echo @$data_get['result'][0]->RETURN_DAYS;} 
 ?>
            <div class="col-sm-4" >    
              <div class="form-group">      
          ...
          <div class="form-group">
             ...
             <input type="hidden" style="display:none;" name="seed_id" id="seed_id" value='<?php echo @$data_get['result'][0]->SEED_ID; ?>'/>
              ...
              <input type="hidden" style="display:none;" name="ebay_id" id="ebay_id" value='<?php echo $this->uri->segment(5); ?>'/>
     ...
     $(".loader").show();
      $.ajax({
         ...
         success: function (data) {
          $(".loader").hide();
             if(clicked_btn == 'revise'){
               var sticker_url = "<?php echo base_url();?>tolist/c_tolist/list_item/"+seed_id+"/"+clicked_btn+"/"+ebay_id; 
             }else{
              if(forceRevise === 1){
                var sticker_url = "<?php echo base_url();?>tolist/c_tolist/forceRevise/"+seed_id+"/"+clicked_btn+"/"+ebay_id;
              }else{
