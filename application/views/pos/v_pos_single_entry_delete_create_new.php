<?php $this->load->view("template/header.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        POS Single Entry Delete &amp; Create New
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>dashboard/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">POS Single Entry Delete &amp; Create New</li>
      </ol>
    </section>
        ...
        <div class="col-sm-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">POS Single Entry Delete &amp; Create New</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="col-sm-10">
          ...
          <?php echo form_open('pos/c_pos_single_entry/update', 'role="form"'); ?>
               ...
               <div class="col-sm-12">
                 <div class="form-group">
                  <div style="color: #dd4b39 !important; background-color: #f2dede!important; border-color: #ebccd1!important;" class="alert alert-danger alert-dismissable fade in">
                    ...
                    <strong>Note:</strong> On update of every pos single entry record <strong>New Barcode</strong> will be generate.
                  </div>                 
                 </div>
               </div>                 
