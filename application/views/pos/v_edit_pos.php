...
<form action="<?php echo base_url(); ?>pos/c_point_of_sale/posUpdate" method="post" name="posUpdate" onsubmit="setTimeout(function(){ location.reload(); }, 1000);" accept-charset="utf-8" target="_blank">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                   <label for="Doc No" class="control-label">DOC No:</label>
                     ...
                     <input  type="hidden" name="lz_pos_mt_id" value="<?php echo $data[0]['LZ_POS_MT_ID'];?>">
                  </div>
                  </div>
                              ...
                              <div class="col-sm-3">
                                <div class="form-group">
                                  <label for="Ad ID" class="control-label">Ad ID:</label>
                                    <input type="text" class="form-control" id="ad_id" name="ad_id" value="<?php //echo $data[0]['LZ_CRAIG_POST_ID'];?>" readonly>
                                </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <table class="table table-bordered " id="dynamic_field">
                          ...
                          <tbody>
                            ...
                            foreach(@$data as $row): ?>
                            <tr>
                              <td> <input class="form-control dynamic" type="number" name="sr_no[]" id="sr_no" value="<?php //echo $i; ?>" readonly>  </td>
                              <td>
                              <input class="form-control" type="text" name="line_type[]" id="line_type" value="<?php //if(@$row['LINE_TYPE'] == "PT"){echo "Parts"; }elseif(@$row['LINE_TYPE'] == "SR"){echo "Service"; }elseif(@$row['LINE_TYPE'] == "SH"){echo "Shipping"; }elseif(@$row['LINE_TYPE'] == "OT"){echo "Other"; } ?>"> 
                              </td>
                              <td><input class="form-control pos_barcode" type="number" name="bar_code[]" id="bar_code<?php //echo $i?>" value="<?php //echo @$row['BARCODE_ID']; ?>"></td>
                              <td><input class="form-control" type="text" name="item_desc[]" id="item_desc<?php //echo $i?>" value="<?php //echo @$row['ITEM_DESC']; ?>"></td>
                              <td><input class="form-control quantity" type="number" name="quantity[]" id="quantity" value="<?php //echo @$row['QTY']; ?>" readonly></td>
                              <td><input class="form-control price" type="number" name="price[]" id="price<?php //echo $i?>" value="<?php //echo @$row['PRICE']; ?>" ></td>
                              <td><input class="form-control perc" type="number" name="disc_perc[]" id="pos_disc_perc<?php //echo $i?>" value="<?php //echo @$row['DISC_PERC']; ?>" ></td>
                              <td><input class="form-control disc" type="number" name="disc_amount[]" id="pos_disc_amount<?php //echo $i?>" value="<?php //echo @$row['DISC_AMT']; ?>" ></td>
                              <td><input class="form-control net" type="number" name="net_amount[]" id="net_amount<?php //echo $i?>" value="" readonly></td>
                              <td><button type="button" name="remove[]" id="button<?php //echo $i?>" class="btn btn-sm btn-danger btn_remove fa fa-trash-o"></button></td>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      <input type="submit" name="addPos_Form" id="save" class="btn  btn-primary" value="Update">
  ...
  <script text="javascript">
   ...
   /*====================================================
    ...
    ====================================================*/
    var data = '<?php $i = 1;foreach(@$data as $row): ?><tr><td> <input class="form-control dynamic" type="number" name="sr_no[]" id="sr_no" value="<?php echo $i; ?>" readonly>  </td><td><input class="form-control" type="text" name="line_type[]" id="line_type" value="<?php if(@$row['LINE_TYPE'] == "PT"){echo "Parts"; }elseif(@$row['LINE_TYPE'] == "SR"){echo "Service"; }elseif(@$row['LINE_TYPE'] == "SH"){echo "Shipping"; }elseif(@$row['LINE_TYPE'] == "OT"){echo "Other"; } ?>" readonly> </td><td><input class="form-control pos_barcode" type="number" name="bar_code[]" id="bar_code<?php echo $i?>" value="<?php echo @$row['BARCODE_ID']; ?>" readonly></td><td><input class="form-control" type="text" name="desc_item[]" id="desc_item<?php echo $i;?>" value="<?php echo @$row['ITEM_DESC']; ?>"></td><td><input class="form-control quantity" type="number" name="quantity[]" id="quantity" value="<?php echo @$row['QTY']; ?>" readonly></td><td><input class="form-control price" type="number" name="price[]" id="price<?php echo $i;?>" value="<?php echo @$row['PRICE']; ?>" step="0.01"></td><td><input class="form-control perc" type="number" name="disc_perc[]" id="pos_disc_perc<?php echo $i;?>" value="<?php echo @$row['DISC_PERC']; ?>" step="0.01"></td><td><input class="form-control disc" type="number" name="disc_amount[]" id="pos_disc_amount<?php echo $i;?>" value="<?php echo @$row['DISC_AMT']; ?>" step="0.01"></td><td><input class="form-control net" type="number" name="net_amount[]" id="net_amount<?php echo $i?>" value="0" readonly></td><td><button type="button" name="remove[]" id="<?php echo $i;?>" class="btn btn-sm btn-danger btn_remove fa fa-trash-o"></button></td></tr><?php 
                          $i++;
                          endforeach;  ?>';
      
      $('#dynamic_field').append(data);
     // $('#dynamic_field').append('<tr ><td style="width:50px;"><div style="width:50px;"><input type="number" class="form-control dynamic" id="sr_no'+i+'" name="sr_no[]" value="1"  readonly></div></td><td style="width:90px;"><div style="width:100%;"><select class="form-control lType" id="line_type'+i+'" name="line_type[]"><option value="PT">Parts</option><option value="SR">Service</option><option value="SH">Shipping</option><option value="OT">Other</option></select></div></td><td style="width:100px;"><div style="width:100%;"><input type="number" class="form-control pos_barcode" id="bar_code'+i+'" name="bar_code[]" value="" required></div></td><td style="width:340px;"><div style="width:100%;"><input type="text" class="form-control" id="desc_item'+i+'" name="desc_item[]" value="" ></div></td><<td style="width:50px;"><div style="width:100%;"><input type="number" class="form-control quantity" id="quantity'+i+'"  name="quantity[]" value="'+1+'" readonly ></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control price" id="price'+i+'" step="0.01" name="price[]" required></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control perc" id="pos_discount_perc'+i+'"  step="0.01" name="dis_percent[]" ></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control disc" step="0.01" id="pos_disc_amount'+i+'" name="disc_amount[]" value=""></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control net" id="pos_net_price'+i+'"  name="net_price[]" readonly ></div></td><td style="width:23px;"><div style="width:100%;"><button type="button" name="remove" id="button'+i+'" class="btn btn-sm btn-danger btn_remove fa fa-trash-o"></button></div></td></tr>');
      ...
      $('#add').click(function(){
        ...
        i++;
         ...
         $('#dynamic_field').append('<tr ><td style="width:50px;"><div style="width:50px;"><input type="number" class="form-control dynamic" id="sr_no'+i+'" name="sr_no[]" value=""  readonly></div></td><td style="width:90px;"><div style="width:100%;"><select class="form-control lType" id="line_type'+i+'" name="line_type[]"><option value="PT">Parts</option><option value="SR">Service</option><option value="SH">Shipping</option><option value="OT">Other</option></select></div></td><td style="width:100px;"><div style="width:100%;"><input type="number" class="form-control pos_barcode" id="bar_code'+i+'" name="bar_code[]" value="" required></div></td><td style="width:340px;"><div style="width:100%;"><input type="text" class="form-control" id="desc_item'+i+'" name="desc_item[]" value="" ></div></td><<td style="width:50px;"><div style="width:100%;"><input type="number" class="form-control quantity" id="quantity'+i+'"  name="quantity[]" value="'+1+'" readonly ></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control price" id="price'+i+'" step="0.01" name="price[]" required></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control perc" id="pos_disc_perc'+i+'" value="0"  step="0.01" name="disc_perc[]" ></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control disc" step="0.01" id="pos_disc_amount'+i+'" name="disc_amount[]" value="0"></div></td><td style="width:85px;"><div style="width:100%;"><input type="number" class="form-control net" id="net_amount'+i+'"  name="net_price[]" readonly ></div></td><td style="width:23px;"><div style="width:100%;"><button type="button" name="remove" id="button'+i+'" class="btn btn-sm btn-danger btn_remove fa fa-trash-o"></button></div></td></tr>');
        ...
        $('.perc').on('blur',function(){
          ...
          var discount_i = parseFloat($('#pos_disc_perc'+num+'').val());
          if(discount_i == ''){
            discount_i = 0;
          }
          // alert(jQuery.type(discount_i));
          // if(isNaN(discount_i)){
          //   discount_i = parseFloat(discount_i);
          // }
          // alert(parseFloat(discount_i));
          var disc_A = (parseFloat(discount_i)*parseFloat(price_i))/100;
          if(disc_A == ''){
            disc_A = 0;
            $('#pos_disc_amount'+num+'').val(0);
          }else{
          ...
          $('#net_amount'+num+'').val(net_p.toFixed(2));
      });
      ...
      $('.disc').on('blur',function(){//  For discountAmount on Price Fields Calculation
        ...
        $('#pos_disc_perc'+num+'').val(disc_i.toFixed(2));
    ...
    /*=================================================
    =   claculations before editing the fields         =
    ===================================================*/
    ...
    $('.net').each(function(){
      var num = this.id.match(/\d+/);
      var price = parseFloat($('#price'+num+'').val());
      var discAmt = parseFloat($('#pos_disc_amount'+num+'').val());
      var net_p = parseFloat(price)-parseFloat(discAmt);
      parseFloat($('#net_amount'+num+'').val(net_p.toFixed(2)));
    });
    ...
    $("input[class *= 'quantity']").each(function(){
        num = $(this).val();
        totalQty += parseFloat(num);
    });
      
    parseFloat($('#pos_total_quantity').val(totalQty));
    ...
    parseFloat($('#pos_total_price').val(totalPrice));

    var totalDisc =0;
    $("input[class *= 'disc']").each(function(){
        num = $(this).val();
        totalDisc += parseFloat(num);
    });

    parseFloat($('#pos_disc_total_amount').val(totalDisc));

    var totalNetPrice =0;
    $("input[class *= 'net']").each(function(){
        num = $(this).val();
        totalNetPrice += parseFloat(num);
    });

    parseFloat($('#pos_net_total_price').val(totalNetPrice));


    if($('#exempt').val() == 1){
      $('#exempt').prop('checked',true);
      var t_A = parseFloat($('#pos_net_total_price').val());
      var minusTax = (parseFloat(t_A)/100)*8.25; 
      minusTax.toFixed(2);
      var exemptedA = $('#pos_total_amount').val()- parseFloat(minusTax);
    ...
    if($('#exempt').val() == 0){
      ...
      var t_A = parseFloat($('#pos_net_total_price').val());
      var plusTax = (parseFloat(t_A)/100)*8.25; 
      plusTax.toFixed(2);
      plusTax = parseFloat(plusTax);
      var notExemptedA = parseFloat($('#pos_total_amount').val()) + parseFloat(plusTax) ;
    ...
    var payable = parseFloat(totalNetPrice)+parseFloat($('#s_tax_amt').val());
    parseFloat($('#pos_total_amount').val(payable.toFixed(2)));


    /*======== End Calculations before editing ========*/
   ...
   /*=====  End of Payment Block Checks  ======*/ 
    ...
    $('.disc').on('blur',function(){//  For discountAmount on Price Fields Calculation
      ...
      $('.net').on('blur',function(){
        ...
        $(".totalNetPrice").val(sum.toFixed(2));
         if($('#s_tax').val()==8.25){
            var taxPrice = (sum/100)*8.25;
            taxPrice= parseFloat(taxPrice);
            $('#s_tax_amt').val(taxPrice.toFixed(2));
