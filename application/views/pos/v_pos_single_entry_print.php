 <?php $this->load->view('template/header'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        POS Single Entry Manifest Sticker

        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>dashboard/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">POS Single Entry Manifest Sticker</li>
      </ol>
    </section>
                ...
                <div class="box-body form-scroll">
                  <table id="manfDetailSticker" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <a onclick="return reloadWind();" href="<?php echo base_url(); ?>pos/c_pos_single_entry/manifest_print/<?php echo @$print_qry['LAPTOP_ITEM_CODE'].'/'.@$print_qry['LZ_MANIFEST_ID'].'/'.@$print_qry['IT_BARCODE']; ?>" title="Print Sticker" class="btn btn-primary btn-sm" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
                          </td>
