        ...
        <div class="col-sm-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url(); ?>rssFeed/c_rssFeed/CatFiltercatAuction" target="_blank" method="post" accept-charset="utf-8">
                ...
                <label for="feed_url">Category:</label>
                    <div class="form-group">
                      ...
                      <?php foreach (@$data['cat_id_qry'] as $row): ?>
                        <option value="<?php echo @$row['CATEGORY_ID'];?>"><?php echo @$row['CATEGORY_ID'].'-'.@$row['CATEGORY_NAME'].' ('.@$row['TOTAL_QTY'].')';?></option>
                      <?php endforeach;?>
                      </select>
                    </div>                                     
                </div> 
...
if(dataTable != ''){
     ...
     dataTable = $('#rssFeedTable').DataTable({
      ...
      "bAutoWidth": false,
      "ajax":{
        url: '<?php echo base_url();?>rssfeed/c_rssfeed/loadCatAuction', 
        type: 'post',
        dataType: 'json'//,
        //data:{}
      },
