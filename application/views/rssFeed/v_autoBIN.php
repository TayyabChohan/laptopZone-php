...
if(dataTable != ''){
     ...
     dataTable = $('#rssFeedTable').DataTable({
      ...
      "bAutoWidth": false,
      "ajax":{
        url: '<?php echo base_url();?>rssfeed/c_rssfeed/loadAutoBIN', 
        type: 'post',
        dataType: 'json'//,
        //data:{}
      },
...
=======================================================*/
  ...
  // $(".loader").show();
  $.ajax({
      url: '<?php echo base_url(); ?>rssfeed/c_rssfeed/updateAutoBIN',
      type: 'post',
      dataType: 'json',
