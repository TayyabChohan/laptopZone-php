          ...
          <div class="col-sm-12">
            <div class="col-sm-2">
              <div class="form-group pull-left">
                <a title="Add Category Data" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>bigData/c_bigData_1/addCategoryData" target="_blank">Add Category Data
                </a>
              </div>
            </div>
          </div>     
  ...
  $(document).ready(function(){
   /* var dataTable = $('#categoryList').DataTable({
    ...
    // "pageLength": 5,
      ...
      // "bAutoWidth": false,
      "ajax":{
        url :"<?php echo base_url() ?>bigData/c_bigDataTest/loadData", // json datasource
        type: "post"  // method  , by default get
        // data: {},
