...
/* ==================== Start Checking Status of Order ============================  */
    ...
    // ===================== End Checking if record already exist ===============================
                ...
                if($num_row == false){
                    ...
                    $qry = "UPDATE LZ_SALESLOAD_DET SET TRACKING_NUMBER ='$TRACKING_NUMBER',SHIPPED_ON_DATE = $SHIPPED_ON_DATE,ORDERSTATUS='$ORDERSTATUS' WHERE TRANSACTION_ID='$TRANSACTION_ID'";
                }
