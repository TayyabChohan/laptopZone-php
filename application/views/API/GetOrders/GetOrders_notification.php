...
?>
<?php 
//require_once('eBaySession.php');  //include session file for curl operations 
//require_once('/get-common/eBaySession.php');
require('/../get-common/eBaySession.php');
//require_once('db_connection.php');
//var_dump($Timestamp);//exit;
$qry = $this->db->query("insert into EBAY_NOTEIFICATION (test_pk,NOTIFICATION_TYPE,insert_date,E_data) values (get_single_primary_key('EBAY_NOTEIFICATION','test_pk'),'$NotificationEventName',sysdate,'$ItemID')");
//exit;
?>
<?php
