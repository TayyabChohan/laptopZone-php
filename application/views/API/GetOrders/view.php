...
if ($entries == 0) {
    ...
    if ($orders != null) {
        foreach ($orders as $order) {
            ...
            if(!empty($order->ShippedTime)){echo "ShippedTime:".$order->ShippedTime. "\n";}else{echo "ShippedTime: Awaiting Shipment\n";}
            //echo "ShippedTime:".$order->ShippedTime. "\n";
            echo "Buyer ID:".$order->BuyerUserID. "\n";
            echo "Record No.:". $order->ShippingDetails->SellingManagerSalesRecordNumber. "\n";
            //exit;
            ...
            if ($orderStatus) {
                ...
                if ($transactions) {
                    ...
                    foreach ($transactions->Transaction as $transaction) {
                        ...
                        echo "CreatedDate : " . $transaction->CreatedDate . "\n";
