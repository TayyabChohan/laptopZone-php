...
=============================================*/
if($shippedtime == 0 && $orderStatus != 'Cancelled' && $TRACKING_NUMBER == '')
{
$TransactionID = $TRANSACTION_ID;
$SaleRecordID  = $recordnumber;
$OrderLineItemID = $orderlineitemid;                           
$lz_seller_account_id = $LZ_SELLER_ACCT_ID;
$this->db->query("INSERT INTO LZ_AWAITING_SHIPMENT
(TRANSACTIONID, SALERECORDID, ORDERLINEITEMID, LZ_SELLER_ACCOUNT_ID)
select 
 '$TransactionID',
 '$SaleRecordID',
 '$OrderLineItemID',
 '$lz_seller_account_id' from dual where not exists
(select *
   from lz_awaiting_shipment a
  where a.salerecordid = '$SaleRecordID'
    and a.lz_seller_account_id = '$lz_seller_account_id')
"); 
}
