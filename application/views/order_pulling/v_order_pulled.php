<?php $this->load->view("template/header.php"); ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Pulled Summary</h3>
    ...
    <div class="col-sm-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Pulled Detail</h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
          </div>
        ...
        <div class="box-body">
          <div class="form-scroll">
            <table id="PulledTab" class="table table-bordered table-hover">
              <thead>
              ...
              <tbody>
              <?php foreach($pulled as $pull_order): ?>
                <tr>
                  <td>
                    <div class="weight_print">
                      <form action="<?php echo base_url();?>order_pulling/c_order_pulling/save_print" method="post" target="_blank">
                        ...
                        <input type="hidden" name="order_no" id="order_no" value="<?php echo @$pull_order['SALES_RECORD_NUMBER'];?>">
                  ...
                  <td><?php echo @$pull_order['BARCODE_NO'];?></td>
                  <td><?php echo @$pull_order['SALES_RECORD_NUMBER'];?></td>
                  <td><?php echo @$pull_order['ITEM_ID'];?></td>
                  <td><?php echo @$pull_order['ITEM_TITLE'];?></td>
                  <td><?php echo @$pull_order['QUANTITY'];?></td>
                  <td><?php echo @$pull_order['PULLING_QTY'];?></td>
                  <td><?php echo @$pull_order['CANCEL_QTY'];?></td>
                  <td><?php echo @$pull_order['SALE_DATE'];?></td>
                  <td><?php echo '$ '.number_format((float)@$pull_order['SALE_PRICE'],2,'.',','); ?></td>
                  <td><?php echo '$ '.number_format((float)@$pull_order['TOTAL_PRICE'],2,'.',',');?></td>
                  <td><?php echo @$pull_order['USER_ID'];?></td>
                  <td><?php echo @$pull_order['BIN_NAME'];?></td>
                  <td><?php echo @$pull_order['PULLER_NAME'];?></td>
                  <td><?php echo @$pull_order['PULLING_DATE'];?></td>
                  <!-- <td><?php //echo @$pull_order['WIZ_ERP_CODE'];?></td> -->
