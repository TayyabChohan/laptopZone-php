...
if ($entries == 0) {
    ...
    //select * from LZ_SALESLOAD_MT where loading_date = to_timestamp('2/26/2016 5:36:29 AM', 'dd/mm/yyyy hh24:mi:ss')
               ...
               // date_default_timezone_set("Asia/Karachi");
                ...
                $this->db->query("insert into EBAY_NOTEIFICATION (test_pk,E_data,insert_date) values (get_single_primary_key('EBAY_NOTEIFICATION','test_pk'),'inside order array',sysdate)");
...
$this->db->query("insert into EBAY_NOTEIFICATION (test_pk,E_data,insert_date) values (get_single_primary_key('EBAY_NOTEIFICATION','test_pk'),'insisde order foreach : $tottal_order ',sysdate)");
