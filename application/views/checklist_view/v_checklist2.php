    ...
    <section class="content">
      <div class="row">
        <div class="col-sm-12">
          ...
          <?php echo form_open('checklist/c_checklist/save_checklist', 'id="checklist_form"', 'role="form"'); ?>
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <label for="Checklist Name" class=" control-label">Checklist Name:</label>
                        ...
                        <input type="text" class="form-control" id="check_list_name" name="checklist_name" placeholder="Enter Checklist Name" required>
                    </div>
                  </div>
                  <div class="col-sm-2">
              ...
              ?>
                  ...
                  <td>
                        ...
                        <input style="margin-right: 8px;" class="pull-left" type="checkbox" name="check_list[]" value="<?php echo $key['LZ_TEST_MT_ID']; ?>">
              ...
              ?>
                ...
                <div style="margin-top: 10px;" class="col-sm-12 buttn_submit">
                  <div class="form-group">
                    <input type="submit" name="submit_checklist" title="Save Checklist" class="btn btn-success" value="Save">
