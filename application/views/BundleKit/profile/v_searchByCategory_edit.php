        ...
        <div class="col-sm-12">
          <div class="box">
            ...
            ?>
              ...
              <?php if(empty($bk_template)){ ?>
              <b>Template Name:</b> &nbsp;&nbsp;<?php echo $components[0]['ITEM_TYPE_DESC'];
                }else{
                    $bk_template= str_replace("%20", ' ', $bk_template);
                  ?>
                  <b>Template Name:</b> &nbsp;&nbsp;<?php echo $components[0]['ITEM_TYPE_DESC']; ?><br>
            ...
            <?php
              ...
              $catsNames=explode(":", $catArray);

              $main_cat = @$catsNames[0];
              $sub_cat = @$catsNames[1];
              $cat_name = @$catsNames[2];
              //list($mainCategory, $subCategory, $CategoryName) = 
              ?>
                        ...
                        <div class="panel-heading" role="tab" id="headingOne_<?php echo $j; ?>">
                          <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordion_<?php echo $j; ?>" href="#collapseOne_<?php echo $j?>" aria-expanded="true" aria-controls="collapseOne_<?php echo $j; ?>">
                              ...
                              <b>Main Category:</b> &nbsp;&nbsp;<?php echo @$main_cat; ?> 
                              &nbsp;&nbsp;&nbsp;&nbsp;
                              <?php if(!empty($sub_cat)){ ?>
                              <b>Sub Category:</b> &nbsp;&nbsp;<?php echo @$sub_cat; ?> 
                              &nbsp;&nbsp;&nbsp;&nbsp;
                              <?php } ?>
                              <b>Category Name:</b> &nbsp;&nbsp;<?php echo @$cat_name; ?> 
                              &nbsp;&nbsp;&nbsp;&nbsp; 
