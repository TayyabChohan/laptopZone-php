<?php $this->load->view('template/header');?><!-- Content Wrapper. Contains page content -->
      ...
      <div class="box">
		...
		<?php if($this->session->flashdata('warning'))
          ...
          <div class="alert alert-warning">
	       ...
	       ?>
      		<div class="col-sm-12">
      			<form action="<?php echo base_url();?>BundleKit/c_bkProfiles/directDataAccessing" method="post">
      			    <div class="col-sm-3">
      		...
      		<div class="col-sm-12">
      			<div class="form-group col-sm-3">
      				...
      				<select name="item_template" class="form-control" required="required">
      					<option value="">---</option>
      					<?php                                
	                if(isset($_POST['item_template'])){
	                    foreach ($templates as $cat) {
	                        $bkTempId=$cat['LZ_BK_ITEM_TYPE_ID'];
                           	...
                           	?>
                           	<option value="<?php echo $cat['LZ_BK_ITEM_TYPE_ID']; ?>"  <?php echo $selected; ?> > <?php echo $cat['ITEM_TYPE_DESC']; ?></option>
                           	<?php
                            }  
                       }else{
                       	    foreach ($templates as $cat){
                           	?>
                       	<option value="<?php echo $cat['LZ_BK_ITEM_TYPE_ID']; ?>" > <?php echo $cat['ITEM_TYPE_DESC']; ?>
                        </option>
                       	<?php
                      } 
                    }
