			...
			<form action="<?php echo base_url();?>BundleKit/c_bk_kit/showDataForKit" method="post">
				<div class="row">
					<div class="form-group col-sm-3">
						...
						<input class="form-control" type="text" name="kit_name" id="kitName" value="<?php if(isset($_POST['kit_name'])){echo $_POST['kit_name'];}; ?>" required="required"  readonly>
					</div>
				</div>
				 <div class="row">
				 <?php //var_dump($kitId); exit; ?>
					<div class="form-group col-sm-3">
						<label for="item_template">Profile Name:</label>
                    	<input  type="text" name="bk_kit_item" class="form-control" id="bk_kit_item" value="<?php echo @$bk_kit_item; ?>" readonly>
					</div>
				</div>
				<div class="row form-group col-sm-12" style="display: none;">
                  ...
                  <tbody>
					...
					<div class="form-group" style="margin-left: 6px;">
            			<button class="btn btn-primary" id="update_kit" kitid="<?php echo $kitId; ?>">Update</button>
        			</div>
                  <?php
                      } 
                  endif;
...
$("#update_kit").click(function(){
  ...
  var arr=[];
  var url='<?php echo base_url() ?>BundleKit/c_bk_kit/updateKitData'; 
  ...
  //console.log(activePrice, manualPrice); return false;
  $.ajax({
    url:url,
    type: 'POST',
    data: {
    ...
    success: function (data) {
         if(data != ''){
           window.location.href = "<?php echo base_url(); ?>BundleKit/c_bk_kit/showKitDetail/"+kitid;
