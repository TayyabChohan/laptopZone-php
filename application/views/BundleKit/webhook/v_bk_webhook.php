  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      require_once('/../../API/get-common/eBaySession.php');
       ?>
			<div class="col-sm-12">
				<form action="<?php echo base_url();?>BundleKit/c_bk_webhook/addWebhook" method="post">
				    <div class="col-sm-3">
		              <div class="form-group">
		                  <label for="webhook_name">Webhook Name:</label>
		                  <input class="form-control" type="text" name="webhook_name" id="webhook_name" value="<?php if(isset($_POST['webhook_name'])){ echo $_POST['webhook_name']; }; ?>" required="required"> 
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="webhook_condition" name="webhook_condition" required>
                  ...
                  <option value="7000">For Parts or Not Working</option>
					...
					<div class="form-group col-sm-3">
						<label for="web_keyword">Keyword</label>
						<input class="form-control" type="text" id="web_keyword" name="web_keyword" value="<?php if(isset($_POST['web_keyword'])){ echo $_POST['web_keyword']; }; ?>">
					</div>
				</div>
				<div class="col-sm-12">
...
/*-- End Suggest Cotegories against title on single entry --*/ 
  ...
  $("#webhook_name").blur(function()
  	{  	
  		var webhook_name=$(this).val();
  		$("#web_keyword").val(webhook_name);
  	});
 });
      /*-- End Suggest Cotegories --*/
         function hook_Function(i) {
            ...
            document.getElementById("main_category").value=cat_name;
            document.getElementById("sub_category").value=main_cat;
            document.getElementById("category_name").value=sub_cat;   
        }
/*-- End Suggest Cotegories against title on single entry --*/
</script>
