...
<p>
<a href="<?php echo site_url('seed/c_seed/add') ?>" class="btn btn-primary">Add New</a>
</p>
<div class="table-responsive">
   <table class="table table-bordered table-hover table-striped">
      <caption>Seed Form</caption>
      <thead>
        <tr>
          <th width="80px">ERP Code</th>
          <th>ERP Inventory Description</th>
          <th>UPC</th>
          <th>SKU</th>
          <th>Manufacturer</th>
          <th>Part No.</th>
  ...
  ?>
        ...
        <td><?php echo @$row->ITEM_TITLE; ?></td>
         ...
         <td><?php echo @$row->SHIPPING_PAID_BY; ?></td>      
          <!--<td>--><?php //echo $row->TEMPLATE_ID; ?><!--</td>-->
          <td>
           <a href="<?php echo site_url('forms/template/c_temp/edit/' . @$row->ITEM_ID); ?>" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a><br>
           <a href="<?php echo site_url('forms/template/c_temp/delete/' . @$row->TEMPLATE_ID); ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
          </td>
      <?php
      }
  }
