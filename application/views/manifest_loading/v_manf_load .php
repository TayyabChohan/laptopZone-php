                  ...
                  <table id="manfRePrintSticker" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a onclick="return reloadWind();" href="<?php echo base_url(); ?>manifest_loading/c_manf_load/manifest_print/<?php echo @$re_print_qry['LAPTOP_ITEM_CODE'].'/'.@$re_print_qry['LZ_MANIFEST_ID'].'/'.@$re_print_qry['IT_BARCODE']; ?>" title="Print Sticker" class="btn btn-success btn-sm" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
                          </td>
