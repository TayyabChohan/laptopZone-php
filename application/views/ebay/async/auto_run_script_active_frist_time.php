...
===============================================================*/
//this file use to download active data for given category for the very first time
...
/*=====  End of FOR RUNNING PHP FILE USING CLI (COMMAND LINE INTERFACE)  ======*/
    ...
    $select_brand = "SELECT UPPER(D.SPECIFIC_VALUE) SPECIFIC_VALUE FROM CATEGORY_SPECIFIC_MT M, CATEGORY_SPECIFIC_DET D WHERE M.EBAY_CATEGORY_ID = $cat_id AND M.CUSTOM = 0 AND UPPER(M.SPECIFIC_NAME) = 'BRAND' AND UPPER(M.SPECIFIC_NAME) <> 'N/A' AND UPPER(M.SPECIFIC_NAME) <> 'UNBRANDED/GENERIC'AND D.MT_ID = M.MT_ID"; 
