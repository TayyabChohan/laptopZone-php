...
/*=====  End of FOR RUNNING PHP FILE USING CLI (COMMAND LINE INTERFACE)  ======*/
 ...
 /* --Call log insertion start 19-08-2017-- */
            ...
            $min_max_query = "SELECT LAPTOP_ZONE.DATE_TO_UNIX_TS(MIN(D.INSERTED_DATE)) MIN_TIME, LAPTOP_ZONE.DATE_TO_UNIX_TS(MAX(D.INSERTED_DATE)) MAX_TIME FROM $table_name D";
