...
//var_dump($rs['LZ_BD_CATA_ID']);exit;  
            ...
            // }else{
            //     $insert_qry = "UPDATE $table_name SET TITLE = '$title', CONDITION_ID = '$condition_Id', CONDITION_NAME = '$condition_name', SALE_PRICE = $price, LISTING_TYPE = '$listingType', START_TIME = $startTime, SALE_TIME = $endTime, INSERTED_DATE = $inserted_date, FEEDBACK_SCORE = '$feedbackscore', STATUS = 'ACTIVE',MAIN_CATEGORY_ID = '$main_category_id', BID_COUNT = '$bid_count' WHERE EBAY_ID = $itemId AND SALE_TIME = $endTime"; 
            // }
