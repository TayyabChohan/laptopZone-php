...
foreach ($seed_data as $row)
{
       ...
       // }
        ...
        }// ifelse !empty($list_barcode) close
...
// =========================== ItemSpecifics End ===============================  
        ...
        $item->PayPalEmailAddress = $config['production']['paypal_address'];
...
$this->session->unset_userdata('list_barcode');//set in v_item_seed
?>