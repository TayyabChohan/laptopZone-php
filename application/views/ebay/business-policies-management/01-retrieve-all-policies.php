...
//$request->profileName = "techbargains2015";
/**
 * Send the request.
 */
...
if ($response->ack !== 'Success') {
    ...
    if (isset($response->paymentProfileList)) {
        ...
        foreach ($response->paymentProfileList->PaymentProfile as $profile) {
            ...
            //     $profile->profileDesc
            // );
             echo "<br>Profile ID: ".$profile->profileId."<br> Profile Name: ".$profile->profileName."<br> Profile Description: ".$profile->profileDesc;
        }
    }
