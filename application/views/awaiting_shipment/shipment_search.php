      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="box">
            ...
            <div class="col-sm-2">
              <input class="btn btn-primary" title="Search Awaiting Shipment Orders" type="submit" name="submit" value="Search">
            </div>
      <!--  <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              ...
              <input type="button" id="GetOrders" title="Get Awaiting Shipment Orders" class="btn btn-default" name="GetOrders" value="Refresh">
            </div>
             <!-- <div class="col-sm-3">
