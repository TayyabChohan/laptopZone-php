...
*/
?>
<?php //echo 'https://pay.ebay.com/xo?action=create&rypsvc=true&pagename=ryp&TransactionId=-1&item='.$ebay_id.'&quantity=1'; exit; ?>
<!-- https://pay.ebay.com/xo?action=create&rypsvc=true&pagename=ryp&TransactionId=-1&item=253658109213&quantity=1 -->
<!DOCTYPE html>
<html>
<head>
...
<iframe id="test_frame" src="<?php echo 'https://pay.ebay.com/xo?action=create&rypsvc=true&pagename=ryp&TransactionId=-1&item='.$ebay_id.'&quantity=1'; ?>" height="800" width="1500" target="_parent" onload="onLoadHandler();"> 
