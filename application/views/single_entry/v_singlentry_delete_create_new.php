<?php $this->load->view("template/header.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Single Entry Delete &amp; Create New
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>dashboard/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Single Entry Delete &amp; Create New</li>
      </ol>
    </section>
        ...
        <div class="col-sm-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Single Entry Delete &amp; Create New</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="col-sm-10">
          ...
          <?php echo form_open('single_entry/c_single_entry/update', 'role="form"'); ?>
 ...
 -->
                <div class="col-sm-3">
                  <div class="form-group">
                    <label for="UPC" class="control-label">UPC:</label>
                      <input type="number" class="form-control" id="upc" name="upc" value="<?php echo @$row['ITEM_MT_UPC'];?>" >
                ...
                <div class="col-sm-3">
                  ...
                  <label for="Manufacture" class="control-label">Manufacture:</label>
                    ...
                    <input type="text" class="form-control" id="manufacturer" name="manufacturer" value="<?php echo @$row['ITEM_MT_MANUFACTURE'];?>" required>
                  </div>
                </div>                
                ...
                <div class="col-sm-3">
                  ...
                  <label for="MPN" class="control-label">MPN:</label>
                    ...
                    <input type="text" class="form-control" id="part_no" name="part_no" value="<?php echo @$row['ITEM_MT_MFG_PART_NO'];?>" >
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
...
<!--                <div class="col-sm-2">
              ...
              <div class="col-sm-2">
                <div class="form-group">      
                    ...
                    <?php
                    foreach ($cond as $val) { 
                    if(strtoupper(trim($val['COND_NAME'])) == strtoupper(trim(@$row['CONDITIONS_SEG5']))){
                      $selected = 'selected';
                    }else{
                      $selected = '';
                    }
                      ?>
                      <option value="<?php echo $val['COND_NAME']; ?>" <?php echo $selected; ?>><?php echo $val['COND_NAME']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-sm-12"> 
                ...
                <div class="col-sm-3">
                  ...
                  <label for="Available Qty" class="control-label">Available Qty:</label>
                    <input type="number" class="form-control" id="avail_qty" name="avail_qty" value="<?php echo @$row['AVAILABLE_QTY'];?>" required>
                  </div>
                </div>
              </div>     
              <div class="col-sm-12">
