...
class RSSParser {
	...
	function parse()
	{
		...
		// echo $result[0]."<br>";
		// $result = $xml->xpath('/rss/channel/item/rx:CurrentPrice');
		// echo $result[0]."<br>";
		// print_r($result);exit;
		if ($xml->channel)
		{
			...
			//$this->channel_data['ch_link'] = $xml->channel->image->link;
			...
			foreach ($xml->channel->item as $item)
			{
				...
				$data['CurrentPrice'] = $xml->xpath('/rss/channel/item/rx:CurrentPrice');
				$data['ch_link'] = $xml->xpath('/rss/channel/image/link');
				$data['Category'] = $xml->xpath('/rss/channel/item/rx:Category');
				//$data['CurrentPrice'] = (string)$item->CurrentPrice;
