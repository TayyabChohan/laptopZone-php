...
class c_alternateMpnUpload extends CI_Controller{
	public function __construct(){
	      parent::__construct();
	      $this->load->database();
        $this->load->model('catalogue/m_alternateMpnUpload');
        /*============================ =================
      ...
      $result['pageTitle'] = 'Alternate Mpn Upload';
      $this->load->view('catalogue/v_alternateMpnUpload',$result);
 	 ...
 	 public function importFile()
  	  {   
     	$this->m_alternateMpnUpload->import_xls_record();
