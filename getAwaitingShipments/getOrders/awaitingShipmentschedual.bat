...
title getAwaitingShipments 
%~d0 REM GIVE DIRECTORY ALPHABET I.E D:
cd %_full_path%
	php index.php cron_job c_cron_job getAwaitingShipments 2
	php index.php cron_job c_cron_job getAwaitingShipmentsDetails 2
	php index.php cron_job c_cron_job getOrders_new
	php index.php cron_job c_cron_job shopifyOrdersReviseCall
